    ...
    return (
        <div onChange={handleChange}>
            ...
            <div className="row mt-3">
                ...
                <div className="col-md-6 mb-3">
                    <input type="text" placeholder="Phone Number" name="number" className="form-control" />
                </div>
            </div>
            ...
            <div className="row">
                ...
                <div className="col-md-3 mb-3">
                    <select name="state" name="state" className="form-select form-select-lg form-control">
                        {states.map((state) => (
                ...
                <div className="col-md-3 mb-3">
                    <input type="text" placeholder="Zip Code" name="zip" className="form-control" />
                </div>
            </div>
            <div className="row">
                <div className="col-12">
